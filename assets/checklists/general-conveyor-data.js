window.CHECKLIST_DATA = {
  storageKey: 'general-conveyor',
  docTitle: 'General Conveyor Inspection Checklist',
  docStandard: 'Condition Monitoring Rotating Equipment · Lotus Engineering Department',
  docNo: 'CM-CONV-GEN-001',
  revision: 'Rev 1',
  ...
  sections: [
    ...
    },
    {
      title: 'Motor',
      items: [
        { id: '2.1', text: 'Check general condition and listen for unusual noise' },
    ...
    },
    {
      ...
      items: [
        { id: '3.1', text: 'Check general condition and listen for unusual noise' },
        { id: '3.2', text: 'Inspect coupling hubs for cracks' },
        { id: '3.3', text: 'Record jaw coupling and fluid coupling temperature (°C)' }
      ]
    },
    {
      title: 'Gearbox',
    ...
    },
    {
      title: 'Grid Coupling',
      items: [
        { id: '5.1', text: 'Check general condition and listen for unusual noise' },
        { id: '5.2', text: 'Inspect coupling hubs for cracks' },
        { id: '5.3', text: 'Record coupling temperature (°C)' }
      ]
    },
    {
      title: 'Head - Snub - Tail Pulley',
      items: [
        { id: '6.1', text: 'Check pillow block general condition and listen for unusual noise' },
        ...
        { id: '6.4', text: 'Record head/tail/snub pulley temperatures (DE/NDE)' }
      ]
    },
    {
      title: 'Bend Pulley - Counterweight & Take-Up Pulley',
      items: [
        { id: '7.1', text: 'Check pillow block general condition and listen for unusual noise' },
        { id: '7.2', text: 'Inspect safety guard' },
        { id: '7.3', text: 'Record bend and take-up pulley temperatures (DE/NDE)' }
      ]
    }
  ],
  summaryTable: {
    columns: ['Component', 'Condition', 'Priority', 'Action', 'Date'],
    rows: ['Motor', 'Fluid Coupling', 'Gearbox', 'Grid Coupling', 'Head/Snub/Tail Pulley', 'Bend/Counterweight/Take-Up Pulley']
  },
